...
**Canonical branch:** `cursor/make-v22` → PR into `main`.
...
- Lineage: make-v18 (TF **1.3.0 (69)**) → make-v19 (TF **1.3.0 (71)**) → make-v20 (TF **1.3.0 (73)**) → make-v21 (TF **1.3.0 (76)**) → **make-v22**. See `docs/choremaxx-make-v21.md`.
...
- **Shipped baseline:** `cursor/make-v22` (inherits make-v21 / TF **1.3.0 (76)**). Do not abandon it for other `cursor/*` branches.
