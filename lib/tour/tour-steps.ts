...
const ADMIN_PLAN: TourChapter = {
  ...
  steps: [
    ...
    step({
      ...
      body: 'Switch to Itineraries for multi-stop trips. Calendar stays for single events.',
      route: '/(tabs)/plan',
    ...
    step({
      ...
      title: 'Smart Trips',
      body: 'Poppins bundles errands into one route. Ask, use the calendar, or start blank.',
      route: '/(tabs)/plan',
      onEnter: 'plan.itineraries',
      ensureVisible: true,
    }),
    step({
      ...
      title: 'Build a trip',
      body: 'Tap New to add stops in order — school, pharmacy, store — then save the route.',
      route: '/(tabs)/plan',
      onEnter: 'plan.itineraries',
    ...
    step({
      ...
      title: 'My Places',
      body: 'Save home, school, and stores once. Trips reuse them instead of retyping addresses.',
      route: '/(tabs)/plan',
      onEnter: 'plan.places',
      ensureVisible: true,
    }),
    step({
      ...
      body: 'Add Home first. Mark favorites so Poppins knows where routes should start and end.',
      route: '/(tabs)/plan',
      onEnter: 'plan.places',
      ensureVisible: true,
    }),
...
const ADMIN_REWARDS: TourChapter = {
  ...
  steps: [
    ...
    step({
      ...
      title: 'The vault',
      body: 'Finished chores bank XP here. Kids spend that XP on rewards you approve.',
      route: '/(tabs)/rewards',
      when: 'showRewards',
    ...
    step({
      ...
      title: 'Make a reward',
      body: 'Screen time, choose dinner, a trip — set the XP cost when you create it.',
      route: '/(tabs)/rewards',
      when: 'showRewards',
      onEnter: 'rewards.vault',
    }),
