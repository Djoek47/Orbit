...
const ADMIN_PEOPLE: TourChapter = {
  ...
  steps: [
    step({
      id: 'people.members',
      targetId: 'settings.members',
      title: 'Your people',
      body: 'Add Sidekicks and a second grown-up here.',
      route: '/settings',
      ensureVisible: true,
    }),
    step({
    ...
    step({
      id: 'people.ipad',
      targetId: 'members.sharedIpad',
      title: 'Family iPad',
      body: 'Kids can share one iPad and switch by tapping their face.',
      route: '/settings',
      ensureVisible: true,
    }),
  ],
